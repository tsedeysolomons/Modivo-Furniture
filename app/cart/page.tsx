...
import { Search, ShoppingCart, User, Menu, Minus, Plus, Trash2, ArrowRight, ArrowLeft } from "lucide-react"
      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center max-w-md mx-auto">
            ...
            <h1 className="text-2xl font-bold font-serif text-foreground mb-4">Your Cart is Empty</h1>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center justify-between mb-6">
              <h1 className="text-2xl font-bold font-serif text-foreground">Shopping Cart</h1>
              <span className="text-muted-foreground">{state.itemCount} items</span>
            </div>

            <div className="space-y-4">
              {state.items.map((item) => (
                <Card key={`${item.id}-${item.color}-${item.size}`} className="border-border bg-card">
          ...
          <div className="lg:col-span-1">
            <Card className="sticky top-24 border-border bg-card">
              <CardContent className="p-6">
                <h2 className="text-xl font-semibold font-serif text-card-foreground mb-6">Order Summary</h2>

                <div className="space-y-4">
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Subtotal ({state.itemCount} items)</span>
                    <span className="font-medium text-card-foreground">${state.total.toLocaleString()}</span>
                  </div>
                  ...
                  <div className="flex justify-between text-lg">
                    ...
                    <span className="font-bold text-card-foreground">${finalTotal.toFixed(2)}</span>
                  </div>
                </div>
